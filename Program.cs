namespace task1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            library.AddBook(new Book(1, "999", "beboo"));
            library.AddBook(new Book(2, "The Hobbit", "J.R.R. Tolkien"));
            library.AddBook(new Book(3, "piano time", "bithofin"));

            library.AddMember(new Member(1, "sami"));
            library.AddMember(new Member(2, "laila"));
